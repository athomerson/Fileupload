...
#from collective.widget.fileupload.testing import TestRequest, DummyContext
from zope.publisher.browser import TestRequest as BaseTestRequest
from plone.app.widgets.interfaces import IWidgetsLayer
from zope.interface import implements, Interface
from collective.widget.fileupload.widget import Upload, Download, DownloadExisting
...
class FileUploadWidgetTests(unittest.TestCase):
    ...
    def setUp(self):
        from collective.widget.fileupload.widget import FileUploadWidget

        self.request = TestRequest(environ={'HTTP_ACCEPT_LANGUAGE': 'en', 'REQUEST_METHOD': 'POST', 'files[]': None})
    ...
    def test_widget(self):        
        ...
        self.assertEqual(
            ...
            'pattern_options': {'url': 'http://127.0.0.1/++widget++None/@@upload/', 'existing': [{'name': u'file.txt',
                                'size': 14,
                                'title': u'file.txt',
                                'url': u'http://127.0.0.1/++widget++None/@@downloadexisting/file.txt'}]}},
            self.widget._base_args(),
        )        
    ...
    def test_widget_cleanup(self):
        ...
        new_mtime = mtime - 25 * 60 * 60 #new modification time 25 hours ago
    ...
    def test_fieldwidget(self):
        from collective.widget.fileupload.widget import FileUploadWidget
        from collective.widget.fileupload.widget import FileUploadFieldWidget
    ...
    def test_download_existing(self):
        ...
        self.assertEqual(self.request.response.getHeader('Content-Disposition'),
                         'attachment; filename="extfile.txt"',)
        ...
        self.assertEqual(self.request.response.getHeader('Content-Disposition'),
                         'attachment; filename="sillyfile.txt"',)
